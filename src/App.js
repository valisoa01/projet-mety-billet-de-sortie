    ...
    <div className="App">
      <Router>
        <Routes>
          ...
          <Route path="/Connections/AdminHome/AjouterEtudiant" element={<AjouterEtudiant />} />
          <Route path="/Connections/AdminHome/SupprimerEtudiant" element={<SupprimerEtudiant />} />
          <Route path="/Connections/AdminHome/AjouterGardien" element={<AjouterGardien />} />
          <Route path="/Connections/AdminHome/SupprimerGardien" element={<SupprimerGardien />} />
          <Route path="/Connections/AdminHome/EnvoyerBilletSortie" element={<EnvoyerBilletDeSortie />} />
          <Route path="/Connections/AdminHome/HistoriqueSortie" element={<HistoriqueSortie />} />
